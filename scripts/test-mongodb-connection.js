...
// Run this script from the backend directory: cd backend && node ../scripts/test-mongodb-connection.js
...
const testConnection = async () => {
  ...
  if (process.env.MONGODB_URI.includes('username:password') || 
    ...
    console.error('   Please update backend/.env with your actual MongoDB connection string');
